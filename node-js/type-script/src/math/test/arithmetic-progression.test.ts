...
import { calculateArithmeticProgressionSum } from '../arithmetic-progression.ts';
...
describe('calculateArithmeticProgressionSum', () => {
  ...
  it('should handle zero difference', () => {
    ...
    assert.strictEqual(calculateArithmeticProgressionSum(4, 0, 3), 12);
  });
});
